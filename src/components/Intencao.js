...
import { Form, Icon, Input, Button, Card, Row, Col, Typography, Tooltip, Divider, List, Empty, Comment, Alert, Badge } from 'antd';
        ...
        <Row>
            <Col span={12} offset={6}>
                ...
                {intencoes && intencoes.length === 0 && <div style={{ textAlign: 'center' }}>
                    <br /><br />
                    <Alert type="warning" message="Esta oração não existe." />
                    <br/><br/>
                    <Button onClick={() => abrirModalRastrarIntencao()} style={{ color: '#a25050' }} type="link"><FaPray /> Rastrear Intenção</Button>
                </div>}
                {!intencoes && <div style={{ textAlign: 'center' }}>
                    <br /><br />
                    <Icon type="loading" spin /> Buscando Oração...
                </div>}
