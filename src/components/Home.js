        ...
        <Row type="flex" justify="center" align="top">
            <Col lg={18} md={18} sm={20} xs={20}>
                ...
                <Tabs type="card" tabBarExtraContent={operations}>
                    ...
                    <TabPane tab={t('tab.about')} key="2">
                        <Trans i18nKey='tab.about.description'>
                            sospray é uma iniciativa sem fins lucrativos para ajudar pessoas que sentem necessidade de pedir orações por um problema sério que esteja passando. Pensamentos ruins, de suicídio, problemas nas quais aparentemente não há solução, Deus pode intervir e uma palavra, uma oração, pode salvar uma vida.
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <br /><br /><br />
                    <div><span style={{ fontFamily: `'Pacifico', cursive` }}>sospray</span> <FaCopyright style={{ margin: '-2px 9px' }} /> 2020</div>
                </div>
